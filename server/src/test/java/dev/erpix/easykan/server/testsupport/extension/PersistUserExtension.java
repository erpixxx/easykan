...
public class PersistUserExtension implements AfterEachCallback, BeforeEachCallback {
	...
	public void beforeEach(ExtensionContext context) {
		AnnotationSupport.findAnnotation(context.getElement(), WithPersistedUsers.class).ifPresent(ann -> {
		...
		AnnotationSupport.findAnnotation(context.getElement(), WithPersistedUser.class).ifPresent(ann -> {
